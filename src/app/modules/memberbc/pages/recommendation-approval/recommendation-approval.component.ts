...
@Component({
  selector: 'app-recommendation-approval',
  templateUrl: './recommendation-approval.component.html',
  styleUrls: ['./recommendation-approval.component.css']
})
export class RecommendationApprovalComponent implements OnInit {
  ...
  getMemberList() {
    this.filterForm.get("MemberApprovalStatus").patchValue(MemberApprovalStatus.Processing)
    this.spin = true;
    this.service
      .getMemberPagination(
        this.currentPage,
  ...
  submitStatus(modal: any): void {
    ...
    var obj = {
      ...
      MemberApprovalStatusId: MemberApprovalStatus.Recommended,
